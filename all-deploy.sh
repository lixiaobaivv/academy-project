...
# 前端-前台源码目录
src_html_home="/data/svn/academy-project-home-html"
# 模块名称
html_home="academy-project-home-html"
# 前端-后台源码目录
src_html_admin="/data/svn/academy-project-admin-html"
# 模块名称
html_admin="academy-project-admin-html"

# 后端-源码目录
src_server_home="/data/svn/academy-project"
# 后端-web模块
server_web_home="academy-project-home-web"
server_web_admin="academy-project-admin-web"
# 后端-service模块
server_service_home="academy-project-home-service"
server_service_admin="academy-project-admin-service"
# 后端-core模块
server_core="academy-project-core"

# 前端-部署根目录
deploy_html_home="/data/webs/academy-project-home-web"
deploy_html_admin="/data/webs/academy-project-admin-web"
# Nginx 运行目录
run_html_home=${deploy_html_home}"/run"
run_html_admin=${deploy_html_admin}"/run"

# 后端-部署根目录
deploy_server_home="/data/services/academy-project-service/home"
deploy_server_admin="/data/services/academy-project-service/admin"
# SpringBoot运行目录
...
function restServer() {
    ...
    nohup java -Xms32m -Xmx128m -jar ${runServerName}/${backupsName}-1.0.jar --spring.profiles.active=prod>${runLog}/"`date +%Y%m%d%T`".log 2>&1
}
